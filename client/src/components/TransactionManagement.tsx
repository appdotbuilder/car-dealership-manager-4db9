            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  id="transaction_date"
                  type="date"
                  value={createForm.transaction_date?.toISOString().split('T')[0] || new Date().toISOString().split('T')[0]}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setCreateForm((prev: CreateTransactionInput) => ({ ...prev, transaction_date: new Date(e.target.value) }))
                  }
                  required
                />
              </div>
