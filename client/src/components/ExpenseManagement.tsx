            ...
            <form onSubmit={handleCreate} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  id="expense_date"
                  type="date"
                  value={createForm.expense_date?.toISOString().split('T')[0] || new Date().toISOString().split('T')[0]}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setCreateForm((prev: CreateExpenseInput) => ({ ...prev, expense_date: new Date(e.target.value) }))
                  }
                  required
                />
              </div>
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setUpdateForm((prev) => ({ ...prev, expense_date: new Date(e.target.value) }))
                  }
                />
              </div>
